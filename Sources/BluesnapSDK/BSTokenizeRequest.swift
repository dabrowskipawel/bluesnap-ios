...
/// Ecp/Ach payment details to be submitted to BLS server
public class BSTokenizeEcpAchDetails: BSTokenizePaymentDetails {
    
    public static let ROUTING_NUMBER_KEY = "ecpRoutingNumber"
    public static let ACCOUNT_NUMBER_KEY = "ecpAccountNumber"
    public static let ACCOUNT_TYPE_KEY = "ecpAccountType"
    public static let PAYMENT_METHOD_KEY = "paymentMethod"
    ...
    public init(
        routingNumber: String!, accountNumber: String!, accountType: String!, paymentMethod: String!
    ) {
...
public class BSTokenizeNewCCDetails: BSTokenizeBaseCCDetails {
    var ccNumber: String!
    var cvv: String!
